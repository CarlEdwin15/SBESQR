...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form class="modal-content" action="{{ route('store.student') }}" id="studentRegistrationForm" method="POST"
            ...
            <div class="modal-body">
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <select name="enrollment_type" id="enrollment_type" class="form-select" required>
                            <option value="regular" {{ old('enrollment_type') == 'regular' ? 'selected' : '' }}>
                                Regular</option>
                            <option value="transferee" {{ old('enrollment_type') == 'transferee' ? 'selected' : '' }}>
                                Transferee</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <select name="student_grade_level" id="student_grade_level" class="form-select" required>
                            ...
                            <option value="kindergarten"
                                ...
                                Kindergarten</option>
                            <option value="grade1" {{ old('student_grade_level') == 'grade1' ? 'selected' : '' }}>
                                Grade 1</option>
                            <option value="grade2" {{ old('student_grade_level') == 'grade2' ? 'selected' : '' }}>
                                Grade 2</option>
                            <option value="grade3" {{ old('student_grade_level') == 'grade3' ? 'selected' : '' }}>
                                Grade 3</option>
                            <option value="grade4" {{ old('student_grade_level') == 'grade4' ? 'selected' : '' }}>
                                Grade 4</option>
                            <option value="grade5" {{ old('student_grade_level') == 'grade5' ? 'selected' : '' }}>
                                Grade 5</option>
                            <option value="grade6" {{ old('student_grade_level') == 'grade6' ? 'selected' : '' }}>
                                Grade 6</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <input type="text" name="student_extName" id="student_extName" class="form-control"
                            placeholder="e.g Jr., III (if applicable)" value="{{ old('student_extName') }}" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <input type="text" name="municipality_city" id="municipality_city" class="form-control"
                            placeholder="Enter Municipality or City" value="{{ old('municipality_city') }}" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        <label for="student_fatherFName" class="form-label fw-bold">First
                            Name</label>
                        <input type="text" name="student_fatherFName" id="student_fatherFName" class="form-control"
                            placeholder="Enter Father's First Name" value="{{ old('student_fatherFName') }}" />
                    </div>
                    ...
                    <div class="col mb-2 mt-2">
                        <label for="student_fatherMName" class="form-label fw-bold">Middle
                            Name</label>
                        <input type="text" name="student_fatherMName" id="student_fatherMName" class="form-control"
                            placeholder="Enter Father's Middle Name" value="{{ old('student_fatherMName') }}" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <input type="text" name="student_fatherLName" id="student_fatherLName" class="form-control"
                            placeholder="Enter Father's Last Name" value="{{ old('student_fatherLName') }}" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <input type="text" name="student_motherFName" id="student_motherFName" class="form-control"
                            placeholder="Enter Mother's First Name" value="{{ old('student_motherFName') }}" />
                    </div>

                    <!-- Mother's Middle Name -->
                    <div class="col mb-2 mt-2">
                        <label for="student_motherMName" class="form-label fw-bold">Middle Name</label>
                        <input type="text" name="student_motherMName" id="student_motherMName" class="form-control"
                            placeholder="Enter Mother's Middle Name" value="{{ old('student_motherMName') }}" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        ...
                        <input type="text" name="student_motherLName" id="student_motherLName" class="form-control"
                            placeholder="Enter Mother's Last Name" value="{{ old('student_motherLName') }}" />
                    </div>
