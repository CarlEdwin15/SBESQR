...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <!-- Teacher's Details -->
        <form class="modal-content" action="{{ route('update.teacher', ['id' => $teacher->id]) }}" id="editTeacherForm"
            ...
            <div class="modal-body">
                        ...
                        <div class="col mt-4 mb-3 d-flex align-items-start align-items-sm-center gap-4">
                            <div class="mb-3">
                                @if ($teacher->profile_photo)
                                    <img id="photo-preview" src="{{ asset('storage/' . $teacher->profile_photo) }}"
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <select name="assigned_classes[]" id="assigned_classes" class="mb-2" multiple required>
                ...
                <div class="row">
                    ...
                    <div class="col mb-2 mt-2">
                        <label for="dob" class="form-label fw-bold">Date of
                            Birth</label>
                        <input class="form-control" value="{{ $teacher->dob }}" name="dob" type="date"
                            id="dob" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" value="{{ $teacher->house_no }}" name="house_no" id="house_no"
                            class="form-control" />
                    </div>
                    ...
                    <div class="col mb-3">
                        <label for="street_name" class="form-label fw-bold">Street
                            Name</label>
                        <input type="text" value="{{ $teacher->street_name }}" name="street_name" id="street_name"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" value="{{ $teacher->barangay }}" name="barangay" id="barangay"
                            class="form-control" />
                    </div>
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" value="{{ $teacher->municipality_city }}" name="municipality_city"
                            id="municipality_city" class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" value="{{ $teacher->province }}" name="province" id="province"
                            class="form-control">
                    </div>
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" value="{{ $teacher->zip_code }}" name="zip_code" id="zip_code"
                            class="form-control" />
                    </div>
                </div>
            </div>
