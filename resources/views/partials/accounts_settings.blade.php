                                ...
                                <div class="user-profile-info">
                                    ...
                                    <ul
                                        ...
                                        <li class="list-inline-item">
                                            <i class="icon-base bx bx-palette me-2 align-top"></i><span
                                                class="fw-medium">UX Designer</span>
                                        </li>
                                        <li class="list-inline-item">
                                            <i class="icon-base bx bx-map me-2 align-top"></i><span
                                                class="fw-medium">Vatican City</span>
                                        </li>
                                        <li class="list-inline-item">
                                            <i class="icon-base bx bx-calendar me-2 align-top"></i><span
                                                class="fw-medium"> Joined April 2021</span>
                                        </li>
                                    </ul>
                                </div>
                                <a href="javascript:void(0)" class="btn btn-primary mb-1">
                                    <i class="icon-base bx bx-user-check icon-sm me-2"></i>Connected
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-5 col-md-5">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-user"></i><span class="fw-medium mx-2">Full Name:</span>
                                <span>John Doe</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-check"></i><span class="fw-medium mx-2">Status:</span>
                                <span>Active</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-crown"></i><span class="fw-medium mx-2">Role:</span>
                                <span>Developer</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-flag"></i><span class="fw-medium mx-2">Country:</span>
                                <span>USA</span>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <i class="icon-base bx bx-detail"></i><span class="fw-medium mx-2">Languages:</span>
                                <span>English</span>
                            </li>
                        </ul>
                        ...
                        <ul class="list-unstyled my-3 py-1">
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-phone"></i><span class="fw-medium mx-2">Contact:</span>
                                <span>(123) 456-7890</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-chat"></i><span class="fw-medium mx-2">Skype:</span>
                                <span>john.doe</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-envelope"></i><span class="fw-medium mx-2">Email:</span>
                ...
                <div class="card mb-6">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0 mt-3 pt-1">
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-check"></i><span class="fw-medium mx-2">Task Compiled:</span>
                                <span>13.5k</span>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                                <i class="icon-base bx bx-star"></i><span class="fw-medium mx-2">Projects
                                    Compiled:</span>
                                <span>146</span>
                            </li>
                            <li class="d-flex align-items-center">
                                <i class="icon-base bx bx-user"></i><span class="fw-medium mx-2">Connections:</span>
                                <span>897</span>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="card-action-element">
                                    <div class="dropdown">
                                        <button type="button"
                                            ...
                                            <i
                                                class="icon-base bx bx-dots-vertical-rounded icon-md text-body-secondary"></i>
                                        </button>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-auto">
                                                <button class="btn btn-primary btn-icon">
                                                    <i class="icon-base bx bx-user-x icon-md"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="card-header align-items-center">
                                ...
                                <div class="card-action-element">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0);">Share teams</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0);">Suggest edits</a>
                                            </li>
                            ...
                            <div class="justify-content-between dt-layout-table">
                                <div
                                    ...
                                    <table class="table datatable-project dataTable dtr-column collapsed"
                                        ...
                                        style="width: 100%">
                                        <colgroup>
                                            <col data-dt-column="0" style="width: 48.2625px" />
                                            <col data-dt-column="1" style="width: 58.325px" />
                                            <col data-dt-column="2" style="width: 215.775px" />
                                            <col data-dt-column="3" style="width: 108.325px" />
                                            <col data-dt-column="4" style="width: 105.412px" />
                                        </colgroup>
                                        <thead class="border-top">
                                            <tr>
                                                <th data-dt-column="0" class="control dt-orderable-none"
                                                    rowspan="1" colspan="1" aria-label="" style="">
                                                ...
                                                <th data-dt-column="2" rowspan="1" colspan="1"
                                                    ...
                                                    aria-label="Project: Activate to remove sorting" tabindex="0"
                                                    style="">
                                                    <span class="dt-column-title" role="button">Project</span><span
                                                        class="dt-column-order"></span>
                                                </th>
                                                <th data-dt-column="3" rowspan="1" colspan="1"
                                                    class="dt-orderable-asc dt-orderable-desc"
                                                    aria-label="Leader: Activate to sort" tabindex="0"
                                                    style="">
                                                    <span class="dt-column-title" role="button">Leader</span><span
                                                        class="dt-column-order"></span>
                                                </th>
                                                <th data-dt-column="4" rowspan="1" colspan="1"
                                                    class="dt-orderable-none" aria-label="Team" style="">
                                                    <span class="dt-column-title">Team</span><span
                                                        class="dt-column-order"></span>
                                                </th>
                                                <th class="w-px-200 dt-orderable-asc dt-orderable-desc dt-type-numeric dtr-hidden"
                                                    ...
                                                    style="display: none">
                                                    <span class="dt-column-title" role="button">Progress</span><span
                                                        class="dt-column-order"></span>
                                                </th>
                                                <th data-dt-column="6" rowspan="1" colspan="1"
                                                    class="dt-orderable-none dtr-hidden" aria-label="Action"
                                                    style="display: none">
                                                    <span class="dt-column-title">Action</span><span
                                                        class="dt-column-order"></span>
                                                </th>
                                            </tr>
                                        </thead>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">Website
                                                                SEO</span><small class="text-truncate">10 May
                                                                2021</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="" style="">
                                                    <span class="text-heading">Eileen</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                            ...
                                            <tr>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar avatar-sm me-3">
                                                                <img src="../../assets/img/icons/brands/social-label.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">Social
                                                ...
                                                <td class="" style="">
                                                    <span class="text-heading">Owen</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                            ...
                                            <tr>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar avatar-sm me-3">
                                                                <img src="../../assets/img/icons/brands/sketch-label.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">Logo
                                                ...
                                                <td class="" style="">
                                                    <span class="text-heading">Keith</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                            ...
                                            <tr>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">IOS App
                                                ...
                                                <td class="" style="">
                                                    <span class="text-heading">Merline</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                            ...
                                            <tr>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">Figma
                                                ...
                                                <td class="" style="">
                                                    <span class="text-heading">Harmonia</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                            ...
                                            <tr>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        <div class="avatar-wrapper">
                                                            <div class="avatar avatar-sm me-3">
                                                                <img src="../../assets/img/icons/brands/html-label.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">Crypto
                                                ...
                                                <td class="" style="">
                                                    <span class="text-heading">Allyson</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                            ...
                                            <tr>
                                                ...
                                                <td class="sorting_1" style="">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column gap-50">
                                                            <span class="text-truncate fw-medium text-heading">Create
                                                ...
                                                <td class="" style="">
                                                    <span class="text-heading">Georgie</span>
                                                </td>
                                                <td class="" style="">
                                                    <div class="d-flex align-items-center">
                                                        <ul
                                                ...
                                                <td class="dtr-hidden" style="display: none">
                                                    <div class="d-inline-block">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end m-0">
                                                            <a href="javascript:;"
                                                                class="dropdown-item">Details</a><a
                                                                href="javascript:;"
                                            ...
                                            <ul class="pagination">
                                                <li class="dt-paging-button page-item disabled">
                                                    <button class="page-link previous" role="link"
                                                        ...
                                                        <i
                                                            class="icon-base bx bx-chevron-left scaleX-n1-rtl icon-18px"></i>
                                                    </button>
                                                </li>
                                                ...
                                                <li class="dt-paging-button page-item">
                                                    <button class="page-link next" role="link" type="button"
                                                        ...
                                                        data-dt-idx="next">
                                                        <i
                                                            class="icon-base bx bx-chevron-right scaleX-n1-rtl icon-18px"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                        </nav>
